    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        when(activity?.javaClass?.simpleName){
            AlbumRecyclerActivity::class.simpleName -> {
                ...
                bottomNavigationView.menu.getItem(0).setIcon(R.drawable.ic_menu_user_solid_foreground)
            }
            AlbumDetailActivity::class.simpleName -> {
                bottomNavigationView.menu.getItem(0).isChecked = true
                bottomNavigationView.menu.getItem(0).setIcon(R.drawable.ic_menu_user_bold_foreground)
            }
            MainActivity::class.simpleName -> {
                bottomNavigationView.menu.getItem(1).isChecked = true
                bottomNavigationView.menu.getItem(1).setIcon(R.drawable.ic_menu_main_solid_foreground)
            }
            MusicScannerActivity::class.simpleName -> {
                bottomNavigationView.menu.getItem(2).isChecked = true
                bottomNavigationView.menu.getItem(2).setIcon(R.drawable.ic_menu_mic_solid_foreground)
            }
        }
